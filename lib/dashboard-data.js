...
export function buildDashboardSnapshot() {
  ...
  return {
    ...
    dataSource: {
      ...
      files: ['bts-status.json', 'nbhw-status.json', 'dashboard-status.json', 'bts/content.json', 'bts/seo.json', 'bts/seo-findings-ledger.json', 'bts/news-bank.json', 'bts/readiness.json'],
