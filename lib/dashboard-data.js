...
export function buildDashboardSnapshot() {
  ...
  return {
    ...
    dataSource: {
      ...
      files: ['bts-status.json', 'nbhw-status.json', 'dashboard-status.json', 'bts/content.json', 'bts/seo.json', 'bts/news-bank.json'],
    ...
    btsDrafts: useContentJson ? buildDraftsFromContent(btsContent) : buildDrafts(btsWithSeo),
